...
- Strongest tracked reduction: `qwen3.5:4b` minimal reduced tracked errors from `6 -> 0` across `40` eval items (`15.0% -> 0.0%`).
...
| `claim-ollama-qwen3-5-4b-10-minimal` | `qwen3.5:4b` | improved | +1.25 | `timeout` bucket, baseline `6/40`, RALPH `0/0` |
